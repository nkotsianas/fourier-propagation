% Fraunhofer irradiance plot of donut aperture:
...
U1 = Circ(XI/(2*w1xi),ETA/(2*w1eta)) - Circ(XI/(2*w2xi),ETA/(2*w2eta));
FU1 = dxi*deta*ifftshift(fft2(fftshift(U1)));
FU1A = w1xi*w1eta*Jinc(sqrt(w1xi*w1eta)*sqrt(fXI.^2 + fETA.^2)) - w2xi*w2eta*Jinc(sqrt(w2xi*w2eta)*sqrt(fXI.^2 + fETA.^2));
